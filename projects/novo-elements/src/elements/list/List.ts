...
export class NovoListDividerComponent {
  ...
  public role: string = 'separator';
}

@Component({
  selector: 'novo-list-item',
  template: `
        <div class="list-item" [attr.layout]="direction">
...
export class NovoListItemComponent implements FocusableOption, OnDestroy {
  ...
  constructor(
    ...
    @Optional()
    @Inject(forwardRef(() => NovoListElement))
    public parent: NovoListElement,
  ) {}
