...
import { validateInterpolationProps, interpolate } from '../../utils/Helpers';
  ...
  setItems() {
    ...
    if (this.model && Array.isArray(this.model)) {
      ...
      for (let value of this.model) {
        let label;
        if (this.source && this.source.format && validateInterpolationProps(this.source.format, value)) {
          label = interpolate(this.source.format, value);
        }
