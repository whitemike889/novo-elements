...
@Component({
  ...
  template: `
        ...
        <div>
            <button *ngIf="config.sortable" theme="icon" [icon]="icon" (click)="sort()" [class.active]="sortActive" tooltipPosition="bottom" [tooltip]="labels.sort" data-automation-id="novo-data-table-sort"></button>
